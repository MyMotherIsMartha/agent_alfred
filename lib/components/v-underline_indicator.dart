...
class VUnderlineTabIndicator extends Decoration {
  ...
  Decoration lerpTo(Decoration b, double t) {
    if (b is VUnderlineTabIndicator) {
  ...
  @override
  _VUnderlinePainter createBoxPainter([ VoidCallback onChanged ]) {
    return _VUnderlinePainter(this, onChanged);
  }
}

class _VUnderlinePainter extends BoxPainter {
  _VUnderlinePainter(this.decoration, VoidCallback onChanged)
